...
git add README.md docs .gitignore mlops_20240730/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://dbc-291f38e7-3d24.cloud.databricks.com#setting/accounts) and
  [prod workspace admin console](https://dbc-291f38e7-3d24.cloud.databricks.com#setting/accounts). If
...
If you want to use different catalog names, please update the target names declared in the[mlops_20240730/databricks.yml](../mlops_20240730/databricks.yml) file.
...
Follow the instructions in [mlops_20240730/resources/README.md](../mlops_20240730/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../mlops_20240730/resources/README.md)  to propose, test, and deploy
